...
public class RJCityPickerViewController: UIViewController {
    ...
    private lazy var tableView: UITableView = {
        let tableView = UITableView(frame: CGRect(x: 0, y: kStaBarHeight, width: KScreenW, height: KScreenH - kStaBarHeight), style: .plain)
    ...
    /// 热门城市数据源
    public var hotCities      = ["北京市","上海市","广东市","深圳市","武汉市","天津市","西安市","南京市","杭州市","成都市","重庆市"]{
        didSet{
